...
import sa_b_2.coms309.dungeonadventure.ui.ScreenObjects.GameInviteMessage;

/**
 * Gets the game invites to the current User
 */
public class GetGameInvites {

    /**
     * Gets game invites from the current user
     */
    ...
    private static class AsyncRequests extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            String getRequestsURL = "http://proj-309-sa-b-2.cs.iastate.edu/GetGameInvites.php";
        ...
        protected void onPostExecute(String s) {
            ...
            for (String s1 : names) {
                Constants.screenMessages.add(new GameInviteMessage(s1));
            }
        }
    }
}
